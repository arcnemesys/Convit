...
use crate::{app::App, types::{CommitFooters, CommitType, ConventionalCommit, CurrentScreen, CurrentlyEditing}};
...
impl StatefulList<'_> {
    pub fn with_items<'a>(items: Vec<CommitType>) -> StatefulList<'a> {
        StatefulList {
...
pub struct StatefulList<'a> {
    ...
    pub items: Vec<CommitType>,
    pub last_selected: Option<usize>,
}

#[derive(Debug, Clone)]
pub struct StatefulFooterList<'a> {
    pub state: ListState,
    pub commit: ConventionalCommit<'a>,
    pub items: Vec<CommitFooters>,
    pub last_selected: Option<usize>,
}
impl<'a> StatefulFooterList<'a> {
    pub fn footer_items(items: Vec<CommitFooters>) -> StatefulFooterList<'a> {
        StatefulFooterList {
            state: ListState::default(),
            commit: ConventionalCommit::new(),
            items,
    ...
    pub fn list_footer_items(items: Vec<CommitFooters>) -> StatefulFooterList<'a> {
        StatefulFooterList {
            state: ListState::default(),
            commit: ConventionalCommit::new(),
            items,
